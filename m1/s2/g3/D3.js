...
console.log(femaleCharacters); //  array di personaggi femminili
...
let eyeColor = {
  ...
  brown: [],
  red: [],
  //blue-gray: [] // commento perchè mi da errore
};
console.log(eyeColor); /// oggetto eyeColor con array vuoti
...
//let i =characters.indexOf(femaleCharacters[i]);
//if( i !==-1){
